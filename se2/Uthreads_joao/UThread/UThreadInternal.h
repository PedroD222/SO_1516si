...
typedef struct _UTHREAD_CONTEXT_32 {
	...
	ULONG EBP;
	VOID(*RetAddr)();
	//VOID(*RetAddr)(UT_FUNCTION, UT_ARGUMENT);
...
typedef struct _UTHREAD {
	...
	HANDLE		 ToWaitFor;	//Thread to wait for
...
//
// The default name for a user thread
//
//TCHAR ThreadName  = "Unnamed Thread";
//#define DEFAULT_NAME ThreadName
//
